...
const ThreadList = () => {
  ...
  const statusOptions = [
    ...
    { value: "open", label: t("support.filters.active") },
    { value: "resolved", label: t("support.filters.resolved") },
    { value: "reopened", label: t("support.filters.reopened") },
  ];
          ...
          <div className="flex-1 min-w-[180px]">
            <Select
              ...
              placeholder={
                <div className="flex items-center gap-2">
                  <FiUser size={14} />
                  <span>{t("support.filters.filterByUser")}</span>
                </div>
              }
              noOptionsMessage={() => t("support.filters.noUsersFound")}
            />
          </div>
          ...
          <div className="flex-1 min-w-[160px]">
            <Select
              ...
              placeholder={
                <div className="flex items-center gap-2">
                  <FiFilter size={14} />
                  <span>{t("support.filters.filterByStatus")}</span>
                </div>
              }
            />
          </div>
      ...
      <div className="divide-y divide-gray-100">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-gray-400">
            ...
            <p className="text-xs mt-1">
              {isFilterActive
                ? t("support.tryChangingFilters")
                : t("support.allCaughtUp")}
            </p>
          </div>
        ) : (
          threads?.data?.map((thread) => (
