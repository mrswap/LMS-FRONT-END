...
//               className={`flex items-center justify-between py-1.5 cursor-pointer transition-all duration-200
//               ${level === 0 ? "px-4" : paddingClass}
//               ${
//                 isOpen
//                   ? "text-white"
//                   : level > 0
...
//           ${level === 0 ? "px-4 flex items-center gap-3 " : ` ${paddingClass} pb-1 `}
//           ${
//             location.pathname === item.path
//               ? "bg-[#2563EB] text-white rounded-lg py-2"
//               : level > 0
//                 ? "text-gray-100 hover:text-white hover:bg-blue-500 py-2"
//                 : "text-gray-700 hover:text-blue-600 hover:bg-blue-50 py-2"
//           }`}
//         >
//           {level === 0 && item.icon && <item.icon size={18} />}
...
//         <button className="flex items-center gap-3 px-4 py-2.5 w-full text-sm text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-lg">
//           <FiLogOut size={18} />
//           {t("sidebar.logout")}
//         </button>
//       </div>
