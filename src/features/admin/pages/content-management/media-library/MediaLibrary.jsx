...
const MediaLibrary = () => {
  ...
  // ✅ Fixed: Filter data based on active tab
  // const getFilteredData = () => {
  //   if (!media?.data) return [];
  //   if (activeTab === "all") return media.data;
  //   const selectedTab = tabs.find((tab) => tab.key === activeTab);
  //   return media.data.filter((item) => item.type === selectedTab?.type);
  // };
  ...
  // ✅ Fixed: Helper to get icon based on file type
