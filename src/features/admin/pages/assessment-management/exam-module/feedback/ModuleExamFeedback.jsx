...
const ModuleExamFeedback = () => {
  ...
  const userOptions = [
    { value: "", label: t("moduleExamFeedback.filters.allUsers") },
    ...(users?.data?.map((user) => ({
      value: user.id,
      label: user.name,
      email: user.email,
  ...
  const moduleOptions = [
    { value: "", label: t("moduleExamFeedback.filters.allModules") },
  ...
  const assessmentOptions = [
    { value: "", label: t("moduleExamFeedback.filters.allAssessments") },
  ...
  const ratingOptions = [
    { value: "all", label: t("moduleExamFeedback.filters.allRatings") },
    { value: "5", label: t("moduleExamFeedback.filters.fiveStars") },
    { value: "4", label: t("moduleExamFeedback.filters.fourStars") },
    { value: "3", label: t("moduleExamFeedback.filters.threeStars") },
    { value: "2", label: t("moduleExamFeedback.filters.twoStars") },
    { value: "1", label: t("moduleExamFeedback.filters.oneStar") },
  ];
  ...
  }, [search, selectedUser, selectedAssessment, selectedRating, module]);
  ...
  const columns = [
    {
      header: t("moduleExamFeedback.columns.user"),
      render: (row) => (
        <div>
    ...
    {
      header: t("moduleExamFeedback.columns.assessment"),
      render: (row) => (
        <div>
          ...
          <p className="text-xs text-gray-500 capitalize">
            {row?.assessment?.type || t("moduleExamFeedback.exam")}
          </p>
        </div>
      ),
    },
    {
      header: t("moduleExamFeedback.columns.scorePercentage"),
      render: (row) => (
        <div>
          <p className="font-medium text-gray-800">
            {t("moduleExamFeedback.score")}: {row?.attempt?.score || 0}
          </p>
          <p className="text-xs text-gray-500">
            {t("moduleExamFeedback.percentage")}:{" "}
            {row?.attempt?.percentage || "0"}%
          </p>
        </div>
      ),
    },
    {
      header: t("moduleExamFeedback.columns.rating"),
      render: (row) => (
    ...
    {
      header: t("moduleExamFeedback.columns.date"),
      render: (row) => (
        <div>
  ...
  return (
    <PageLayout>
      <PageHeader>
        <PageHeaderLeft>
          <PageTitle>{t("moduleExamFeedback.title")}</PageTitle>
          <PageSubtitle>{t("moduleExamFeedback.subtitle")}</PageSubtitle>
        </PageHeaderLeft>
        <PageHeaderRight />
      </PageHeader>
          ...
          <div className="w-full">
            ...
            >
              ...
              <input
                ...
                placeholder={t("moduleExamFeedback.searchPlaceholder")}
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="w-full sm:w-[48%] lg:w-[210px]">
              <Select
                ...
                isSearchable={true}
                placeholder={t("moduleExamFeedback.filters.filterByUser")}
              />
            </div>
            ...
            <div className="w-full sm:w-[48%] lg:w-[210px]">
              <Select
                ...
                styles={customSelectStyles}
                isSearchable={true}
                placeholder={t("moduleExamFeedback.filters.filterByAssessment")}
              />
            </div>
            ...
            <div className="w-full sm:w-[48%] lg:w-[210px]">
              <Select
                ...
                styles={customSelectStyles}
                isSearchable={false}
                placeholder={t("moduleExamFeedback.filters.filterByRating")}
              />
            </div>
            ...
            <div className="w-full sm:w-[48%] lg:w-[210px]">
              <Select
                ...
                styles={customSelectStyles}
                isSearchable={true}
                placeholder={t("moduleExamFeedback.filters.filterByModule")}
              />
            </div>
