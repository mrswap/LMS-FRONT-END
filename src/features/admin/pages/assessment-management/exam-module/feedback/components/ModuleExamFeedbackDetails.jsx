...
//         items={[
//           {
//             label: t("examFeedback.breadcrumb.list"),
  ...
  return (
    <PageLayout>
      <Breadcrumb
        items={[
          {
            label: t("moduleExamFeedback.breadcrumb.list"),
            path: "/exam-module-feedback",
          },
          { label: t("moduleExamFeedback.breadcrumb.details") },
        ]}
      />
        ...
        {feedbackData && (
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
              <div className="flex justify-between items-start">
                <div>
                  <h1 className="text-2xl font-semibold text-gray-900">
                    {feedbackData.assessment?.title ||
                      t("moduleExamFeedback.details.feedbackDetails")}
                  </h1>
                  <p className="text-sm text-gray-500 mt-1">
                    {t("moduleExamFeedback.details.assessmentType")}:{" "}
                    <span className="capitalize">
                      {feedbackData.assessment?.type}
                    </span>
                  </p>
            ...
            <div className="p-6">
              <div className="mb-6 pb-4 border-b border-gray-200">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("moduleExamFeedback.details.userInformation")}
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <FaUser size={14} className="text-gray-400" />
                    <div>
                      <p className="text-xs text-gray-500">
                        {t("moduleExamFeedback.details.name")}
                      </p>
                      <p className="text-sm text-gray-800 font-medium">
                        {feedbackData.user?.name}
                      </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs text-gray-500">
                        {t("moduleExamFeedback.details.email")}
                      </p>
                      <p className="text-sm text-gray-800">
                        {feedbackData.user?.email}
                      </p>
              ...
              <div className="mb-6 pb-4 border-b border-gray-200">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("moduleExamFeedback.details.assessmentDetails")}
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <MdQuiz size={14} className="text-gray-400" />
                    <div>
                      <p className="text-xs text-gray-500">
                        {t("moduleExamFeedback.details.assessmentId")}
                      </p>
                      <p className="text-sm text-gray-800">
                        #{feedbackData.assessment?.id}
                      </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs text-gray-500">
                        {t("moduleExamFeedback.details.status")}
                      </p>
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                          feedbackData.attempt?.status === "passed"
                      ...
                      >
                        {t(
                          `moduleExamFeedback.status.${feedbackData.attempt?.status || "na"}`,
                        )}
                      </span>
                    </div>
                  </div>
              ...
              <div className="mb-6">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("moduleExamFeedback.details.review")}
                </h3>
                <div className="bg-gray-50 px-4 py-4 rounded-lg border border-gray-200">
                  <p className="text-gray-700 leading-relaxed">
                    {feedbackData.review || t("moduleExamFeedback.noReview")}
                  </p>
                </div>
              </div>
