...
const OptionDetails = () => {
  ...
  const removeThumbnail = () => {
    setThumbnail(null);
    setThumbnailPreview(option?.option?.file || null);
  ...
  const onSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      if (thumbnail && thumbnail !== option?.option?.file) {
      ...
      toast.success(res?.message || t("option.success.update"));
