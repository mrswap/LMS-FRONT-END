...
//       <Breadcrumb
//         items={[
//           { label: "Quiz Feedbacks", path: "/assessment" },
//           { label: "View Feedback" },
//         ]}
//       />
...
//                     {feedbackData.assessment?.title || "Feedback Details"}
//                   </h1>
...
//                         }`}
//                       >
//                         {feedbackData.attempt?.status?.toUpperCase() || "N/A"}
//                       </span>
//                     </div>
//                   </div>
//                   <div className="flex items-center gap-2">
...
//                     {feedbackData.review || "No review provided"}
//                   </p>
//                 </div>
//               </div>
...
const FeedbackDetails = () => {
  ...
  return (
    <PageLayout>
      <Breadcrumb
        items={[
          { label: t("quizFeedback.breadcrumb.list"), path: "/assessment" },
          { label: t("quizFeedback.breadcrumb.details") },
        ]}
      />
        ...
        {feedbackData && (
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div>
                  <h1 className="text-2xl font-semibold text-gray-900">
                    {feedbackData.assessment?.title ||
                      t("quizFeedback.details.feedbackDetails")}
                  </h1>
                  <p className="text-sm text-gray-500 mt-1">
                    {t("quizFeedback.details.assessmentType")}:{" "}
                    <span className="capitalize">
                      {feedbackData.assessment?.type}
                    </span>
                  </p>
            ...
            <div className="p-6">
              <div className="mb-6 pb-4 border-b border-gray-200">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("quizFeedback.details.userInformation")}
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <FaUser size={14} className="text-gray-400" />
              ...
              <div className="mb-6 pb-4 border-b border-gray-200">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("quizFeedback.details.assessmentDetails")}
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <MdQuiz size={14} className="text-gray-400" />
                    <div>
                      <p className="text-xs text-gray-500">
                        {t("quizFeedback.details.assessmentId")}
                      </p>
                      <p className="text-sm text-gray-800">
                        #{feedbackData.assessment?.id}
                      </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      >
                        {t(
                          `quizFeedback.status.${feedbackData.attempt?.status || "na"}`,
                        )}
                      </span>
                    </div>
                  </div>
              ...
              <div className="mb-6">
                <h3 className="text-sm font-medium text-gray-700 mb-3">
                  {t("quizFeedback.details.review")}
                </h3>
                <div className="bg-gray-50 px-4 py-4 rounded-lg border border-gray-200">
                  <p className="text-gray-700 leading-relaxed">
                    {feedbackData.review || t("quizFeedback.noReview")}
                  </p>
                </div>
              </div>
