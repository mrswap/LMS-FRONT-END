...
//   const handlePaste = (e) => {
//     console.log("Available types:", e.clipboardData.types);
//     console.log("HTML:", JSON.stringify(e.clipboardData.getData("text/html")));
//     console.log(
//       "Plain text:",
...
//       const hex = block
//         .replace(/\{[^{}]*\}/g, "") // strip nested groups (e.g. \picprop)
//         .replace(/\\[a-zA-Z]+-?\d*\s?/g, "") // strip RTF control words
...
//         "Extracted images:",
//         rtfImages.length,
//         rtfImages.map((img) => (img ? img.substring(0, 30) : "NULL")),
//       );
//       if (rtfImages.length) {
...
//     console.log("Has \\pict:", (rtf.match(/\{\\pict/g) || []).length);
//     console.log("Has pngblip:", (rtf.match(/\\pngblip/g) || []).length);
//     console.log("Has jpegblip:", (rtf.match(/\\jpegblip/g) || []).length);
//     console.log("Has wmetafile:", (rtf.match(/\\wmetafile/g) || []).length);
//     console.log("Has emfblip:", (rtf.match(/\\emfblip/g) || []).length);
