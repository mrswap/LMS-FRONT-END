...
//   useEffect(() => {
//     if (isOpen) {
//       // Fetch notifications with pagination params (5 items per page for dropdown)
...
//   // Pagination handlers using server-side pagination
//   const nextPage = () => {
...
//               {/* Classic Pagination with Only Arrow Icons - Using Server Pagination */}
